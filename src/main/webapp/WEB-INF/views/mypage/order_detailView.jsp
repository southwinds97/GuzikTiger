                                        ...
                                        <table border="1">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <fmt:formatDate value="${orderDetailList[0].order_date}"
                                        ...
                                        <table border="1">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="product_total"> <button type="button"
                                                            class="watch_btn">내역보기</button></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <c:forEach var="order" items="${orderDetailList}">
                                        <div class="goods">
                                            ...
                                            <div class="text">
                                                ...
                                                <p class="price">${order.price}원<span
                                                        class="quantity">(${order.quantity}개)</span></p>
                                            ...
                                            <tbody>
                                                <tr class="target">
                                                    ...
                                                    <td class="kring">${orderDetailList[0].product_name} 외 4종</br>
                                                        <span>[옵션:${orderDetailList[0].option_id}]</span>
                                                    </td>
                                                    <td class="score">${orderDetailList[0].quantity}</td> <!-- 수량 -->
                                                    <td class="product_price">${orderDetailList[0].price}</td>
                                                    <!-- 상품구매금액 -->
                                                    <script>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <fmt:formatDate value="${refundDate}"
                                                            pattern="yyyy-MM-dd HH:mm:ss" /><span
                                                            class="repay">(환불완료)</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">환불금액</th>
                                                    <td colspan="3"><span
                                                            class="total">${orderDetailList[0].order_amount}원</span>
                                                    </td>
                                                    <script>
                                                        $('.total').each(function () {
                                                            let price = parseInt($(this).text().replace(/,/g, ''));
