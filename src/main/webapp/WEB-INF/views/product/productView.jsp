          ...
          <div class="imgArea">
            <div class="clearfix">
              ...
              <div class="prdImg pull-right">
                ...
                <div class="xans-element- xans-product xans-product-addimage thumbnail swiper-container jsPrdThumbSlide swiper-container-initialized swiper-container-horizontal" style="cursor: grab;">
                  <ul class="thumbnail__list swiper-wrapper">
                    <li class="thumbnail__item swiper-slide xans-record- swiper-slide-active" style="width: 680px;">
                  ...
                  <div class="thumb-slide__nav thumb-slide__nav--prev jsThumbPrev swiper-button-disabled" tabindex="0" role="button" aria-label="Previous slide" aria-disabled="true"></div>
                  <div class="thumb-slide__nav thumb-slide__nav--next jsThumbNext" tabindex="0" role="button" aria-label="Next slide" aria-disabled="false"></div>
                </div>
              </div>
            </div>
          </div>
          <div class="infoArea">
            <div class="iconArea">
              <button type="button" class="info_btn">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#391818" viewBox="0 0 256 256">
            ...
            <div class="layer">
              <div class="layer_inner">
                  ...
                  <table border="1">
                    ...
                    <tbody class="displaynone">
                      <tr>
                        ...
                        <td class="right">
                          <span class="quantity_price">17000</span>
                          <span class="mileage">
                            (
                            <img src="images/ico_product_point.gif" alt>
                            &nbsp;
                            <span class="mileage_price">850</span>
                            )
                          </span>
                        </td>
                      </tr>
                      <tr id="totalProductsOption" class="product_option">
                      ...
                      <tr class="option_product">
                        ...
                        <td>
                          <span class="quantity" style="width: 65px;">
                            <input type="text" id="option_box1_quantity" name="quantity_opt[]" class="quantity_opt eProductQuantityClass"
                            value="1">
                            <a href="#none" class="up eProductQuantityUpClass">
                              <img src="images/btn_count_up.gif" id="option_box1_up" class="option_box_up" alt="수량증가">
                            </a>
                            <a href="#none" class="down eProductQuantityDownClass">
                              <img src="images/btn_count_down.gif" id="option_box1_down" class="option_box_down" alt="수량감소">
                            </a>
                          </span>
                          <a href="#none" class="delete">
                            <img src="images/btn_delete.gif" id="option_box1_del" class="option_box_del" alt="삭제">
                          </a>
                        </td>
                        <td class="right">
                ...
                <div id="freeShipGuide" class>
                  <div class="text1">
                    <strong class="insufficientPrice">33,000</strong>
                    원만 더 구매하면
              ...
              <div id class="productAction">
                <div class="flex">
                  ...
                  <span class="gActionButtonColumn">
                    <button tpye="button" class="btnNormal sizeL actionCart" onclick="product_submit()" id="actionCart">장바구니</button>
                  </span>
                </div>
                <div id="chatis_gp_button_area" style="display: flex; justify-content: center; padding: 5px 0px 0px 0px;">
                  <button id="chatis_gp_button" onclick="chatisGPApp.clickGiveButton()" type="button"
                  style="font-family:inherit; cursor: pointer; display: flex; align-items:center; justify-content: center; 
                  ...
                  <svg style="width: 19.2px; height: 19.2px; margin-right: 2px;" stroke="#FFFFFF" fill="none" viewBox="0 0 24 24" stroke-width="1.4">
                ...
                <div class="flex soldout displaynone">
                  <button type="button" class="btnSubmit btnSubmit--soldout gFull sizeL displaynone">품절</button>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="product_relation">
                <div class="relation relative">
                  ...
                  <div class="prd-nav-wrap flex flex--v-center">
                    <span class="prd-nav prd-nav--prev flex flex--v-center flex--h-center jsPrdPrev" role="button" aria-label="Previous slide">
                      <svg xmlns="http://www.w3.org/2000/svg" width="6.208" height="11.001" viewBox="0 0 6.208 11.001">
                    ...
                    <span class="prd-nav prd-nav--next flex flex--v-center flex--h-center jsPrdNext" role="button" aria-label="Next slide">
                      <svg xmlns="http://www.w3.org/2000/svg" width="6.208" height="11.001" viewBox="0 0 6.208 11.001">
                        <path id="chevron-down" d="M7.646,14.646a.5.5,0,0,0,.708.708Z
                        M13,10l.354.354L13.707,10l-.353-.354ZM8.354,4.646a.5.5,0,0,0
                        -.708.708Zm0,10.708,5-5-.708-.708-5,5Zm5-5.708-5-5-.708.708,
                  ...
                  <div class="product_relationlist">
                    <div class="swiper-container" style="cursor: grab;">
                      <ul class="prdList grid-slide swiper-wrapper">
                        <li class="prdList__item swiper-slide jsRelatedItem xans-record- swiper-slide-duplicate"
                  ...
                  <div class="eventArea">
                    <div id="CommonEvent2">
                      ...
                      <div class="image_wrap">
                        <img src="/images/1.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <br>
                        <p><br></p>
                        <img src="/images/2.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <p><br></p>
                        <span>언제나 함께 하고 싶은 반려 인형을 찾고 있나요? 무직타이거 뚱랑숲 친구들이 옷도 입고 손도 잡을 수 있는 크기로 찾아왔어요.</span>
                        <p><br></p>
                        <img src="/images/3.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <img src="/images/4.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <img src="/images/5.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <img src="/images/6.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <img src="/images/7.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <img src="/images/8.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <p><br></p>
                        <p><br></p>
                        <p><br></p>
                        <img src="/images/8and9.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <p><br></p>
                        <span>두 손으로 쥐었을 때 행복해지도록 솜량을 조절했어요. 쫀득하고 말랑한 촉감은 사랑을 가득 담고 있답니다. 뚱랑이와 친구들의 뚜렷한 이목구비, 꼭 잡아주고픈 앙증맞은 손, 귀여운 꼬리까지. 작지만 야무진 퀄리티를 경험해보세요.</span>
                        <p><br></p>
                        <img src="/images/9.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <img src="/images/10.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <img src="/images/11.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <p><br></p>
                        <p>
                          <strong>[ 01. 적호 뚱랑이 ]</strong>
                        </p>
                        <img src="/images/12.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <p><br></p>
                        <p>
                          <strong>[ 01. 백호 뚱랑이 ]</strong>
                        </p>
                        <img src="/images/13.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <p><br></p>
                        <p>
                        ...
                        <p><br></p>
                        <p><br></p>
                        <img src="/images/14.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <p><br></p>
                        <span>말랑말랑하게 준비된 뚱랑이와 친구들은 누군가에겐 든든한 반려인형, 누군가에겐 작은 친구 같은 애착인형이 되어줄 거예요.</span>
                        <p><br></p>
                        <img src="/images/14-1.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <img src="/images/14-2.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <img src="/images/14-3.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <img src="/images/14-4.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <img src="/images/14-5.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <img src="/images/14-6.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <p><br></p>
                        <p><br></p>
                        <p><br></p>
                        <img src="/images/15.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <p><br></p>
                        ...
                        <p><br></p>
                        <img src="/images/14-8.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                        <p><br></p>
                        <div class="txt_wrap">
                          <p><br></p>
                          ...
                          <div class="txt_wrap2">
                            ...
                            <div class="txt">
                              ...
                              <p>
                                <span>중성세제를 사용하여 미온수에 손세탁해주시고, 염소계 표백제를 사용하지 마십시오. 세탁 후에는 짜지 말고, 두들기며 물기를 털어주시고 통풍이 잘 되는 그늘진 곳에서 건조하십시오. </span>
                              </p>
                              <p><br></p>
                              <p>
                                <span>
                              ...
                              <p>
                                <span>PC/모바일 기기의 환경에 따라 보이는 색상이 다를 수 있으니, 주문 전 Q&A게시판을 통해 충분한 상담 후 구매 부탁드립니다.</span>
                              </p>
                              <p><br></p>
                              <p>
                                <span>
                            ...
                            <img src="/images/16.png" result="success" name="1.png" size="1000px/559px" filesize="194,54 kB" error=>
                            <p><br></p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="ec-base-fold theme1 eToggle selected">
                      ...
                      <div class="eToggle_content">
                        <div class="info">
                          ...
                          <br>
                          &nbsp; -&nbsp;상품의 하자, 배송 중 파손으로 인한 교환 및 반품은 상품 수령 후 24시간 이내에 QnA 게시판 혹은 톡상담으로 요청 부탁드립니다.
                          <br>
