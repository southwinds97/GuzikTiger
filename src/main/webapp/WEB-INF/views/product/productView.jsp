              ...
              <div class="product_detail">
                ...
                <div class="infoArea">
                      ...
                      <div id class="productAction">
                        <div class="flex">
                          ...
                          <span class="gActionButtonColumn">
                            <button tpye="button" class="btnNormal sizeL actionCart" id="actionCart"
                              onclick="cartInsert()">장바구니</button>
                            <script>
                  ...
                  font-size: 16px; width : 100%; height: 52px; border-radius: 0px;">
                            <svg style="width: 19.2px; height: 19.2px; margin-right: 2px;" stroke="#FFFFFF" fill="none"
                              viewBox="0 0 24 24" stroke-width="1.4">
                    ...
                    <div class="product_relation">
                      <div class="relation relative">
                        ...
                        <div class="prd-nav-wrap flex flex--v-center">
                          <span class="prd-nav prd-nav--prev flex flex--v-center flex--h-center jsPrdPrev" role="button"
                        ...
                        5,5Z" transform="translate(13.707 15.501) rotate(180)">
                          ...
                          <span class="prd-nav prd-nav--next flex flex--v-center flex--h-center jsPrdNext" role="button"
                          ...
                          <div class="swiper-container" style="cursor: grab;">
                            <ul class="prdList grid-slide swiper-wrapper">
                              <c:forEach var="product" items="${productRelateList}">
                                <li class="prdList__item swiper-slide jsRelatedItem xans-record-"
                                  style="width: 202px; margin-right: 10px;">
                                  <div class="thumbnail">
                                    <a href="#" class="thumb">
