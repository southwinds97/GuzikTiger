						...
						<div id="previewContainer" class="preview-container">
							...
							<div class="form-group">
								...
								<div id="target_file_wrap">
									<a href="#" onclick="document.getElementById('upfile').click()"
										class="btn btn-primary">이미지선택</a>
								</div>
							...
							<div class="ArticleWritingTitle">
												...
												<div class="main_Categorie">
													<table border="1" class="option_table">
														...
														<tbody class="option">
															<tr>
																<td>
																	<select name="main_Categories" id="main_Categories"
												...
												<div class="sub_Categorie">
													<table border="1" class="option_table">
														...
														<tbody class="option">
															<tr>
																<td>
																	<select name="sub_cate" id="menu_candidates"
																		class="menu_candidates">
																		...
																		<option value="B004" class="prd2">아크릴 키링
																		</option>
																		<option value="B005" class="prd2">인형 키링</option>
																		<option value="B006" class="prd2">파우치 키링
																		</option>
																		<option value="B007" class="prd3">노트북/태블릿 파우치
																		</option>
																		<option value="B008" class="prd4">패브릭소품</option>
																		<option value="B009" class="prd4">카페트/러그
																		</option>
																		...
																		<option value="B029" class="prd9">리무버블 스티커
																		</option>
																		<option value="B030" class="prd9">조각 스티커
																		</option>
																		<option value="B031" class="prd9">씰 스티커</option>
																		<option value="B032" class="prd9">타투 스티커
																		</option>
																		<option value="B033" class="prd9">마스킹 테이프
																		</option>
																		...
																		<option value="B040" class="prd12">에어팟 케이스
																		</option>
																		<option value="B041" class="prd12">에어팟 프로 케이스
																		</option>
																		<option value="B042" class="prd12">에어팟3 케이스
																		</option>
																		<option value="B043" class="prd12">에어팟 맥스 케이스
																		</option>
																		<option value="B044" class="prd12">버즈케이스
																		</option>
																		<option value="B045" class="prd13">선물패키지
																		</option>
																	</select>
																	<p class="value"></p>
																</td>
								...
								<div class="row">
									<div class="FlexableTextArea">
										<textarea placeholder="상품 이름을 입력해 주세요" name="product_name"
											class="textarea_input" style="height: 28px;"></textarea>
									</div>
								</div>
							</div>
						</div>
