    ...
    <%@ include file="../header.jsp" %>
      <div class="edit_wrap">
            ...
            <table border="1">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" name="passchk" value="${member.pass}" />
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <select id="hint" class="hint" name="hint">
                      ...
                      <option value="hint_05" ${member.hint=='hint_05' ? 'selected' : '' }>타인이 모르는 자신만의 신체비밀이 있다면?
                      </option>
                      <option value="hint_06" ${member.hint=='hint_06' ? 'selected' : '' }>추억하고 싶은 날짜가 있다면?</option>
                      <option value="hint_07" ${member.hint=='hint_07' ? 'selected' : '' }>받았던 선물 중 기억에 남는 독특한 선물은?
                      </option>
                      ...
                      <option value="hint_10" ${member.hint=='hint_10' ? 'selected' : '' }>읽은 책 중에서 좋아하는 구절이 있다면?
                      </option>
                      <option value="hint_11" ${member.hint=='hint_11' ? 'selected' : '' }>자신이 두번째로 존경하는 인물은?</option>
                      <option value="hint_12" ${member.hint=='hint_12' ? 'selected' : '' }>친구들에게 공개하지 않은 어릴 적 별명이 있다면?
                      </option>
                      <option value="hint_13" ${member.hint=='hint_13' ? 'selected' : '' }>초등학교 때 기억에 남는 짝꿍 이름은?
                      </option>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="basic_addr">
                      <input type="text" class="basic" readonly name="addr" value="${member.addr}" placeholder="기본주소"
                        id="address" />
                    </div>
                    <div class="extra_addr">
                      <input type="text" value="${member.detailaddr}" name="detailaddr" placeholder="나머지 주소"
                        id="detailAddress" />
                    </div>
                  </td>
        ...
        <div class="more">
              ...
              <tr>
                ...
                <td>
                  <div class="more_date">
                    ...
                    <input type="radio" class="calendar" id="solar" name="calendar" value="양력" ${member.calendar=='양력'
                      ? 'checked' : '' } />
                    <label for="solar">양력</label>
                    <input type="radio" class="calendar" id="lunar" name="calendar" value="음력" ${member.calendar=='음력'
                      ? 'checked' : '' } />
          ...
          <table border="1">
            <tr>
              <caption>회원 유저 등급</caption>
              <th scope="row">유저 레벨</th>
              <td>
                <!-- 셀렉트 처리 -->
                <select name="user_level" style="width: 50%; line-height: 40px; border: none;">
                  <option value="0" ${member.user_level=='0' ? 'selected' : '' }>관리자</option>
                  <option value="1" ${member.user_level=='1' ? 'selected' : '' }>일반회원</option>
                </select>
              </td>
            </tr>
          </table>
        ...
        <div class="bottom">
          ...
          <button type="button" class="delete_btn" id="deleteBtn">회원탈퇴</button>
        </div>
        <!-- 버튼 처리 -->
        <script>
          $(document).ready(function () {
          ...
          function deleteMember(member_id) {
            if (confirm("회원을 탈퇴시키겠습니까?")) {
              location.href = "/userDelete.do?member_id=" + member_id;
            }
          }
        </script>
        </form>
